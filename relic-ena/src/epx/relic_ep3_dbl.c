 ...
 * @file
 *
 * Implementation of doubling on elliptic prime curves over cubic
 * extensions.
 *
 * @ingroup epx
 */
 ...
 */
static void ep3_dbl_basic_imp(ep3_t r, fp3_t s, ep3_t p) {
	fp3_t t0, t1, t2;
 ...
 * @param[in] p				- the point to double.
 */
static void ep3_dbl_projc_imp(ep3_t r, ep3_t p) {
