/*==========================================================================*/
/*==========                                                   =============*/
/*          Improved Elliptic Net Alg on Twisted BLS curves (RI)            */
/*==========                                                   =============*/
/*==========================================================================*/
...
static void DoubleAndAdd_2(fp12_t initial_data[],fp12_t V2[],fp2_t V1[],bn_t m){
	fp12_t beta,gamma1,gamma2,delta,S_0,P_0,t0;
    	fp2_t alpha,w2,w13,vt1,vt2,vt3,_S1[5],_P1[5];
	int nb,i;
...
/*========================================================*/
		...
		for(i=nb-1;i>=0;i--){
			...
			if (b == 0)
			{
				...
				for(int j=1;j<=6;j++)fp2_mul(V1[j],V1[j],vt3);
			...
			else
			{
				...
				fp2_mul(t0[0][0],vt2,w13);
				fp2_sub(V1[6],V1[6],t0[0][0]);
				for(int j=0;j<=5;j++)fp2_mul(V1[j],V1[j],vt3);
