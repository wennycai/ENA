/*==========================================================================*/
/*===========                                              =================*/
/*               Improved Elliptic Net Alg on BLS curves                    */
/*===========                                              =================*/
/*==========================================================================*/
...
static void DoubleAndAdd_2(fp12_t initial_data[],fp12_t V2[],fp12_t V1[],bn_t m){
	fp12_t alpha,beta,gamma1,gamma2,delta,w2,w13,vt1,vt2,S_0,P_0,t0;
	fp12_t S1[5],P1[5];
	int nb,i;
...
static void DoubleAndAdd_2_lz(fp12_t initial_data[],fp12_t V2[],fp12_t V1[],bn_t m){
	fp12_t alpha,beta,gamma1,gamma2,delta,S_0,P_0,vt1,vt2,w2,w13;
	fp12_t S1[5],P1[5];
	dv12_t t0,t1;
	int nb,i;
	int8_t naf[RLC_BN_BITS + 1];
...
static void DoubleAndAdd(fp12_t initial_data[],fp12_t V2[],fp12_t V1[],bn_t m){
	fp12_t alpha,beta,gamma1,delta,w2,w13,vt1,vt2,S_0,P_0,t0;
	fp12_t S1[5],P1[5];
	int nb,i;
...
static void DoubleAndAdd_lz(fp12_t initial_data[],fp12_t V2[],fp12_t V1[],bn_t m){
	fp12_t alpha,beta,gamma1,delta,S_0,P_0,vt1,vt2,w2,w13;
	fp12_t S1[5],P1[5];
	dv12_t t0,t1;
	int nb,i;
